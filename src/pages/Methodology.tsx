                ...
                <div className="panel border-l-2 border-l-gold p-4">
                  ...
                  <p className="mt-2 text-[14px] leading-6">
                    ...
                    <span className="font-mono text-[13px] font-semibold text-text0">
                      {((hvol.accuracy ?? 0.7999) * 100).toFixed(2)}% accuracy, AUC {(hvol.auc ?? 0.779).toFixed(3)}
                    </span>{' '}
                    vs {(hvol.baseline_class_prior_auc ?? 0.7420).toFixed(4)} class-prior baseline.
                  </p>
                </div>
                <div className="panel border-l-2 border-l-gold p-4">
                  ...
                  <p className="mt-2 text-[14px] leading-6">
                    ...
                    <span className="font-mono text-[13px] font-semibold text-text0">
                      MAE {(hrange.mae ?? 0.3494).toFixed(3)}
                    </span>{' '}
                    vs {(hrange.baseline_mae ?? 0.4312).toFixed(4)} baseline,{' '}
                    <span className="font-mono text-[13px] font-semibold text-text0">
                      R² {(hrange.r2 ?? 0.277).toFixed(3)}
                    </span>
                    .
                  </p>
                </div>
